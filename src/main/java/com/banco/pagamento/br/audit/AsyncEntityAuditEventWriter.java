...
import com.banco.pagamento.br.domain.AbstractAuditingEntity;
import com.banco.pagamento.br.domain.EntityAuditEvent;
import com.banco.pagamento.br.domain.enumeration.EntityAuditAction;
import com.banco.pagamento.br.repository.EntityAuditEventRepository;
 ...
 * to write audit event for entities
 */
@Component
